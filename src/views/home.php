...
<p id="word-count-home"><?php if( count($custom_dictionary) > 0 ){
    echo "Tu diccionario ya tiene " .count($custom_dictionary) . " palabras";
}?></p>
    ...
    $audioData = $wordObj->getAudio($word['str']);
